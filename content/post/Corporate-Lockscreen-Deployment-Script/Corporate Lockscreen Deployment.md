...
description: "Setting the background and lockscreen image for all users on company computers, plus a bonus; Using PowerShell to select a file through a GUI file browser."
